        ...
        {newRec.map((item) => (
          <div className="recipe-img row align-items-center">
            ...
            <div className="recipe-right col-md-6">
              ...
              <hr />
              <p>
                Would you like to learn how to make it? <br /> You can access a
                more detailed version of this recipe, <br /> which includes
      ...
      <div className="popular-recipe">
        ...
        <div className="menu-box">
          {popularRec.slice(0, 6).map((item) => (
            <Link to={`/detail/${item.id}`}>
              <Popular title={item.title} image={item.image} />
            </Link>
          ))}
        </div>
      </div>
